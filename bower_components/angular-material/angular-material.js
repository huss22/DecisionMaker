...
(function () {
    ...
    angular
        ...
        .config(["$provide",
            function ($provide) {
                $provide.decorator('$mdUtil', ['$delegate',
                    function ($delegate) {
                        /**
...
(function () {
    ...
    angular.module('material.core')
        .factory('$mdUtil', ["$cacheFactory", "$document", "$timeout",
            function ($cacheFactory, $document, $timeout) {
                var Util;
                return Util = {
    ...
    function inputTextareaDirective($mdUtil, $window, $compile, $animate) {
        ...
        function postLink(scope, element, attr, ctrls) {
            ...
            function checkHasValue(value) {
                containerCtrl.setHasValue(!isEmpty(value) ||
